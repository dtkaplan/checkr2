...
* `line_value()` - even simpler than `line_where()`, binding just V and EX. Doesn't distinquish assignments from other operations.
* `line_calling()` - looks for a call to a function anywhere in the line. Compare: `line_where()` provides F, which is just the highest-level call. THIS DOESN'T WORK WITH ASSIGNMENT. NEED TO STRIP ANY ASSIGNMENT BEFORE SEARCHING.
