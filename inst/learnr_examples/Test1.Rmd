...
if_matches(USER_CODE, .(fn)(.), failif(TRUE, "{{fn}}() is a function of a single argument. You want a function of two arguments.") )
...
if_matches(USER_CODE, {..(res); `<-`(.(nm), .(val))},
           ...
           if_matches(val, rep(.(a), `..(nm)` = ..(arg2)),
                      ...
                      failif(a != quote(1:4) && a != quote(c(1,2,3,4)), "The elements to be repeated are 1 through 4, not {{a}}. Where do you construct that set to hand to `rep()`?")),
